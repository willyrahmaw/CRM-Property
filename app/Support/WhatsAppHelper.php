...
class WhatsAppHelper
{
    ...
    public static function getLeadTemplates(Lead $lead, ?User $sales = null): array
    {
        ...
        $salutation = $lead->salutation ?? 'Bapak/Ibu';
        ...
        $templates = [
            'catalog_promo' => [
                ...
                'message' => "Halo {$salutation} {$customerName}, terima kasih atas ketertarikannya pada {$projectName}.\n\nPerkenalkan saya {$salesName} dari {$companyName}. Berikut kami kirimkan rangkuman spesifikasi unit dan penawaran promo terbaru. Apakah ada tipe kaveling atau rumah tertentu yang ingin {$salutation} ketahui lebih lanjut?",
            ],
            'site_visit_invite' => [
                ...
                'message' => "Halo {$salutation} {$customerName}, bagaimana kabarnya hari ini?\n\nKami mengundang {$salutation} untuk melihat langsung rumah contoh dan suasana kawasan di {$projectName} akhir pekan ini. Kami siap mendampingi kunjungan lokasi {$salutation}.\n\nKira-kira hari dan jam berapa waktu luang yang paling nyaman bagi {$salutation}?",
            ],
            'kpr_simulation' => [
                'key' => 'kpr_simulation',
                ...
                'message' => "Halo {$salutation} {$customerName}, menindaklanjuti ketertarikan {$salutation} pada {$projectName}.\n\nSaat ini sedang ada program spesial subsidi DP dan bunga KPR ringan dari bank rekanan. Apakah berkenan jika kami bantu buatkan estimasi simulasi angsuran per bulannya sesuai budget {$salutation}?",
            ],
            'followup_warm' => [
                'key' => 'followup_warm',
    ...
    public static function getCustomerTemplates(Customer $customer, ?User $sales = null): array
    {
        ...
        $salutation = $customer->salutation ?? 'Bapak/Ibu';
